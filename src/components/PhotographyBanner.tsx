          ...
          <section className="info-section">
            <div className="left-part">
              ...
              <p className="tracking-widest" style={{ fontWeight: 700 }}>
                Откройте прибыльный пансионат для пожилых <span style={{color:'#e3000f'}}>в любом городе страны</span> — с нуля, под ключ, с опытным наставником рядом.
              </p>
            ...
            <div className="founder-container">
              <div>
                ...
                <p className="founder-text">
                  Ринат Хамитович — человек, который превратил заботу о пожилых людях в настоящее призвание. Более <strong style={{color:'#0a2d8f'}}>10 лет</strong> он строит социальный бизнес, который меняет жизни — и постояльцев, и их семей, и владельцев пансионатов.
                </p>
                <p className="founder-text">
                  Каждый шаг этого пути он прошёл лично: от поиска первого помещения до встречи с первым постояльцем. Сегодня он передаёт этот живой опыт тем, кто только начинает — честно, без лишних слов и с реальным результатом.
                </p>
                ...
                <div className="pricing-card premium">
                  ...
                  <div style={{margin:'16px 0 8px', padding:'16px', background:'rgba(255,255,255,0.15)', borderRadius:'12px', border:'2px solid rgba(245,237,224,0.4)'}}>
                    ...
                    <ul style={{textAlign:'left', padding:'0', lineHeight:'2', fontSize:'17px', margin:0, color:'#f5ede0', listStyle:'none', fontFamily:"'Cormorant Garamond', serif", fontWeight:700}}>
                      <li style={{display:'flex', alignItems:'flex-start', gap:'8px'}}><span style={{marginTop:'4px', flexShrink:0}}>✦</span>1 год личного сопровождения пансионата</li>
