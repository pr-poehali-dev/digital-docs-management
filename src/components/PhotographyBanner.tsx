            ...
            <div className="founder-container">
              <div>
                ...
                <p className="founder-text">
                  Ринат Хамитович — человек, который превратил заботу о пожилых людях в настоящее призвание. Более <strong style={{color:'#0a2d8f'}}>10 лет</strong> он строит социальный бизнес, который меняет жизни.
                </p>
                <p className="founder-text">
